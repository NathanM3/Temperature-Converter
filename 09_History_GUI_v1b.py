...
Changed 3 references to all_calculations to all_calc_list (lines 21, 83 and 86)
(to match 10_Assembled_Converter)
Changed the name of the calc_history button to history_button (lines 78 and 84)
Added the lambda command at liens 82-83
Disabled the history button (lines 86_87) if nothing in the all_calc_list"""
